    ...
    <div className="p-4 sm:p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
        {latestMetrics.map((metric) => {
          ...
          return (
            <div key={metric.id} className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-gray-200">
          ...
          {recentActivities.length === 0 ? (
            ...
            <div className="space-y-4">
              {recentActivities.map((activity) => (
                <div key={activity.id} className="flex items-center space-x-3 p-3 sm:p-4 rounded-lg hover:bg-gray-50 transition-colors">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
        ...
        <button 
          ...
          className="bg-white rounded-lg p-4 sm:p-6 shadow-sm border border-gray-200 hover:shadow-md transition-shadow text-left sm:col-span-1 lg:col-span-2"
        >
          <div className="flex items-center space-x-3">
